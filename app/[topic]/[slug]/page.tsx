    ...
    <>
      ...
      {doc.metadata.topicTitle && doc.metadata.topicSlug && (
        <div className="h-16 flex items-center mb-6">
          <TopicTitle name={doc.metadata.topicTitle} segment={doc.metadata.topicSlug} />
        </div>
      )}
        ...
        <div className="min-w-0">
          ...
          <div className="md:hidden flex items-center mb-8">
            ...
            <div className="flex items-center text-sm whitespace-nowrap min-w-0 ml-3">
              {doc.metadata.topicTitle && (
                <span className="text-slate-600 dark:text-slate-400">{doc.metadata.topicTitle}</span>
              )}
              ...
              <span className="text-slate-800 font-medium truncate dark:text-slate-200">{doc.metadata.title}</span>
            </div>
          </div>
          ...
          <div>
            <header className="mb-6">
              <h1 className="h2 text-slate-800 mb-4 dark:text-slate-200">{doc.metadata.title}</h1>
